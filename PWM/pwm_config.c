...
void PWM1_0_Init()
{
    ...
    PWMGenPeriodSet(PWM1_BASE, PWM_GEN_0, SysCtlClockGet()/DIV/50);//周期50ms
...
void PWM1_2_Init()
{
    ...
    PWMGenPeriodSet(PWM1_BASE, PWM_GEN_1, SysCtlClockGet()/DIV/50);//周期50ms
...
void PWM1_4_Init()
{
    ...
    PWMGenPeriodSet(PWM1_BASE, PWM_GEN_2, SysCtlClockGet()/DIV/50);//周期50ms
